  ...
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-[8] grid grid-cols-5 m-auto items-center justify-center'>
      ...
      <div className='grid'>
        ...
        <div>
          <small className='text-[14px] text-white'> sarthak1234@gmail.com</small>
        </div>
        <div className='icons flex gap-4 py-[1rem]'>
          <AiFillInstagram className='bg-white p-2 h-[35px] w-[35px] rounded-full text-blueColor'/>
          <BsFacebook className='bg-white p-2 h-[35px] w-[35px] rounded-full text-blueColor'/>
          <AiOutlineTwitter className='bg-white p-2 h-[35px] w-[35px] rounded-full text-blueColor'/>
        </div>
      </div>
